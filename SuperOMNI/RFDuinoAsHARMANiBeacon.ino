/*
The sketch demonstrates iBeacon from an RFduino
*/
...
void setup() {
  ...
  uint8_t uuid[16] = {0x5D, 0x37, 0x58, 0xEC, 0x4C, 0x01, 0x4C, 0x38,
0xA1, 0xBF, 0x69, 0xA1, 0x53, 0x6E, 0x35, 0x13};
  memcpy(RFduinoBLE.iBeaconUUID, uuid, sizeof(RFduinoBLE.iBeaconUUID));
  RFduinoBLE.iBeaconMajor = 1100;
  RFduinoBLE.iBeaconMinor = 0001;

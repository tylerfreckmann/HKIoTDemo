...
/*!
 * @brief Deinitialize the HKWirelessHD Controller. After successful deinitialization, the app needs to call initializeHKWirelessController() again to restart HKWirelessHD.
 */
- (BOOL) deinitialize;

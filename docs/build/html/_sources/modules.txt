...
Parse notifies the user of events occuring in the home through push notifications. These notifications are sent to "Installations" which associate apps, users, and devices. HK Rules handles these push notifications in the AppDelegate. The AppDelegate receives the push notifications and activates the speakers accordingly.
